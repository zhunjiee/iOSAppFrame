...
- (void)setupRootViewController {
    DriverHomeViewController *homeVC = [[DriverHomeViewController alloc] init];
    BaseNavigationController *homeNav = [[BaseNavigationController alloc] initWithRootViewController:homeVC];
    
    DriverMenuViewController *menuVC = [[DriverMenuViewController alloc] init];
    BaseNavigationController *mineNav = [[BaseNavigationController alloc] initWithRootViewController:menuVC];
    
    IIViewDeckController *rootController = [[IIViewDeckController alloc] initWithCenterViewController:homeNav leftViewController:mineNav];
...
- (void)setupThirdFrameworks {
    ...
    // 百度地图
//    [self initBaiduMapAndNavigation];
}

#pragma mark - 百度地图
/// 初始化百度地图和百度导航
//- (void)initBaiduMapAndNavigation {
//    // 百度地图
//    BMKMapManager *mapManager = [[BMKMapManager alloc] init];
//    BOOL ret = [mapManager start:const_baidu_key  generalDelegate:nil];
//    if (!ret) {
...
//        [BNaviService_Instance authorizeNaviAppKey:const_baidu_key completion:^(BOOL suc) {
//            NSLog(@"authorizeNaviAppKey ret = %d", suc);
//        }];
//        [BNaviService_Instance authorizeTTSAppId:TTS_APP_ID apiKey:TTS_API_KEY secretKey:TTS_SECRET_KEY completion:^(BOOL suc) {
...
//    NSLog(@"onTTSAuthorized success = %d", success);
//}
